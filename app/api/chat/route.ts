...
import { appendChatLog, getChatLogClientInfo } from "@/lib/chat-log";
import {
      ...
      const input: ResponseInput = [
        {
          ...
          content: [
            ...
            "For W1/W2 cloud amount codes, half sky means 5 parts out of 10. Use W=0 when cloud cover is 5/10 or less throughout the reference period, W=1 when cloud cover is more than 5/10 during some parts and 5/10 or less during other parts, and W=2 when cloud cover is more than 5/10 throughout the whole reference period.",
            ...
            "For ww 91/92, do not choose from thunderstorm evidence alone: both require thunderstorm in the preceding 1 hour but none at observation time, and the deciding difference is the stated light/moderate/heavy intensity. Use ww=91 for light ordinary rain/thunderstorm context and ww=92 when the relevant rain/thunderstorm context is clearly moderate or heavy. If the question says only plain thunderstorm / ฟ้าคะนองเฉยๆ without saying light/moderate/heavy, treat it as light by default and use ww=91 before 92. When ww=91/92 already uses the final-hour thunderstorm plus the present ordinary rain, do not automatically duplicate those same final-hour events into W1/W2. Instead choose W1/W2 from the remaining valid past-weather evidence needed to describe the full reference period. If the earlier part of the reference period before the final-hour thunderstorm/rain has only cloud > half, W1W2 can be 22. Example: secondary time 09:00 UTC, cloud > half from 06:00-08:00, thunderstorm 08:05-08:20, light intermittent ordinary rain 08:20-09:00 gives 7wwW1W2=79122, not 79196 or 79162.",
